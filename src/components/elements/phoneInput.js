  ...
  return (
    <div className="font-serif w-full mb-4 ">
      ...
      <div className="flex relative">
        <span className=" absolute left-2 top-0 h-full flex items-center text-[#616161]  ">
          +1
        </span>
        <input
          className={`${
          ...
          } border-solid border-[0.4px] py-2 px-4 pl-8 w-full h-[40px] text-[#616161] focus:outline-none focus:border-primary focus:text-[#444444] rounded-[6px] shadow-sm bg-[#F2F2F2]
